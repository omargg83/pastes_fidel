...
//	$pdf = new Cezpdf('C8','portrait','color',array(255,255,255)); //ticket 58mm en mozilla
	...
	$data=array();
	$contar=0;
	$pdf->ezText("<b> Reporte de Ventas de Extras por periodo: ".$suc->nombre."</b>",10,array('justification' => 'center'));
//	$pdf->ezText(" ",10);
...
$pdf->ezText(" ",5);
	...
	$pdf->ezText(" ",10);
	$pdf->ezText(" Total de ventas de EXTRAS en el periodo: ".moneda($totalven),14);
