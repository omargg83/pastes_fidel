...
//	$pdf = new Cezpdf('C8','portrait','color',array(255,255,255)); //ticket 58mm en mozilla
	...
	$data=array();
	$contar=0;
	$pdf->ezText("Reporte de Ventas de la sucursal: ".$suc->nombre,12,array('justification' => 'center'));
	$pdf->ezText(" ",10);
	$pdf->ezText("Del: ".$xdel,10,array('justification' => 'center'));
	...
	$pdf->ezTable($data,"","",array('xPos'=>'center','xOrientation'=>'center','cols'=>array(
