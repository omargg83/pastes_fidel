...
<form id='consulta_avanzada' is='f-submit' des='a_reporte/reporte7_res' dix='resultado'  autocomplete='off'>
  <div class='container' >
    <div class="alert alert-light" role="alert">
      <h4 class="alert-heading">VENTAS DE EXTRAS</h4>
      <div class='row'>
      ...
      <div class='row'>
        <div class='col-xl col-auto'>
          <div class='btn-group'>
            ...
            <button type='button' class='btn btn-warning btn-sm'  id='print_persona' is='f-print' title='Editar' des='a_reporte/impventasprodxtra' dix='resultado'><i class='fas fa-print'></i>Imprimir</button>
