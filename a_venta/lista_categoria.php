	...
	echo "<div class='container'>";
	  echo "<div class='row'>";
		foreach($categoria as $key){
	      ...
	      echo "<button type='button' class='btn btn-warning btn-sm mr-1 my-1' style='font-size:10px' id='categorias' is='p-categoria' title='Editar' v_idcategoria='$key->idcategoria'>";
